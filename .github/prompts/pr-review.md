...
- **rAthena as source of truth:** Are new/changed field names, types, and order sourced from rAthena (not the semantic DB or OpenKore or intuition)? Is each claim cited? (Rule 6)
