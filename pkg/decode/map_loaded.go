...
// MapLoaded_0x02EB decodes a 0x02EB packet (struct PACKET_ZC_ACCEPT_ENTER).
func MapLoaded_0x02EB(data []byte, packetver uint32) events.MapLoaded {
	var e events.MapLoaded
