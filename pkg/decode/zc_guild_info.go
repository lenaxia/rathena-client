...
func ZcGuildInfo_0x0A84(data []byte, packetver uint32) events.ZcGuildInfo {
	...
	_ = packetver
	e.GDID = data[2:6]                         // rAthena: GDID (offset 2, size 4)
	e.Level = data[6:10]                       // rAthena: level (offset 6, size 4)
	e.UserNum = data[10:14]                    // rAthena: userNum (offset 10, size 4)
	e.MaxUserNum = data[14:18]                 // rAthena: maxUserNum (offset 14, size 4)
	e.UserAverageLevel = data[18:22]           // rAthena: userAverageLevel (offset 18, size 4)
	e.Exp = data[22:26]                        // rAthena: exp (offset 22, size 4)
	e.MaxExp = data[26:30]                     // rAthena: maxExp (offset 26, size 4)
	e.Point = data[30:34]                      // rAthena: point (offset 30, size 4)
	e.Honor = data[34:38]                      // rAthena: honor (offset 34, size 4)
	e.Virtue = data[38:42]                     // rAthena: virtue (offset 38, size 4)
	e.EmblemVersion = data[42:46]              // rAthena: emblemVersion (offset 42, size 4)
	...
	e.Zeny = data[86:90]                       // rAthena: zeny (offset 86, size 4)
	e.MasterGID = data[90:94]                  // rAthena: masterGID (offset 90, size 4)
	return e
}
...
func ZcGuildInfo_0x01B6(data []byte, packetver uint32) events.ZcGuildInfo {
	...
	e.Zeny = data[110:114]                      // rAthena: zeny (offset 110, size 4)
	return e
}
