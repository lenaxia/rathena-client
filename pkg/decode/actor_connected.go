...
func ActorConnected_0x09FE(data []byte, packetver uint32) events.ActorConnected {
	...
	if packetver >= 20181121 {
		...
		e.Body = leI16(data, 77)              // rAthena: body (offset 77, size 2)
		e.Name = nullTermString(data[79:103]) // rAthena: name (offset 79, size 24)
	}
	return e
}
...
func ActorConnected_0x07F8(data []byte, packetver uint32) events.ActorConnected {
	...
	e.Clevel = leI16(data, 58)      // rAthena: clevel (offset 58, size 2)
	e.Font = leI16(data, 60)        // rAthena: font (offset 60, size 2)
	return e
}
...
func ActorConnected_0x0858(data []byte, packetver uint32) events.ActorConnected {
	...
	e.Clevel = leI16(data, 60)      // rAthena: clevel (offset 60, size 2)
	e.Font = leI16(data, 62)        // rAthena: font (offset 62, size 2)
	return e
}
...
func ActorConnected_0x090F(data []byte, packetver uint32) events.ActorConnected {
	...
	e.Clevel = leI16(data, 60)      // rAthena: clevel (offset 60, size 2)
	e.Font = leI16(data, 62)        // rAthena: font (offset 62, size 2)
	e.MaxHP = leI32(data, 64)       // rAthena: maxHP (offset 64, size 4)
	e.HP = leI32(data, 68)          // rAthena: HP (offset 68, size 4)
	e.IsBoss = data[72]             // rAthena: isBoss (offset 72, size 1)
	return e
}
